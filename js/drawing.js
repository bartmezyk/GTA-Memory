...
const drawing = () =>
{
	...
	else //W przeciwnym wypadku poprzednio wylosowana postać ma nie być brana pod uwagę przy aktualnym losowaniu (aby nie zdarzyło się, by ta sama postać była wylosowana kilka razy z rzędu).
	{
		...
		for(i = 0; i < 4; i++)
		{
			if(i != sequenceNumber[sequenceNumber.length - 1]) numbersForDrawing.push(i); //Tylko numer postaci poprzednio wylosowanej nie znajdzie sie w tymczasowej tablicy numerów postaci do aktualnego losowania.
		}
